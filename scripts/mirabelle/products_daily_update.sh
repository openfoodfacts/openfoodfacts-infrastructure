...
cd $path
mode="" # Enter "i" to get the interactive mode
...
$(curl https://gist.githubusercontent.com/CharlesNepote/80fb813a416ad445fdd6e4738b4c8156/raw/ff008e945ebb1379d713097358fd1284d4b71831/create_from_new_csv.sql)
.mode ascii
.separator "\t" "\n"
