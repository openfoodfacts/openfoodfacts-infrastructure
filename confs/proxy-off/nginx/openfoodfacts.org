...
server {
    ...
    if ($http_user_agent = "python-requests/2.28.2"){
         # add_header Content-Type text/plain;
         # default_type text/plain;
         return 429 "You are sending too many requests. Get in touch: contact@openfoodfacts.org and use the database dumps instead: https://world.openfoodfacts.org/data";
    }
