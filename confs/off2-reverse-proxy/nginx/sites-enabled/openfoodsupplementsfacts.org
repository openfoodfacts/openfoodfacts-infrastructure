...
# create zone "ofsf" for rate limiting 
limit_req_zone $binary_remote_addr zone=ofsf:10m rate=240r/m;


server {
    listen 80;
    listen [::]:80;
    server_name openfoodsupplementsfacts.org *.openfoodsupplementsfacts.org;
...
server {
    ...
    # SSL/TLS settings
    ssl_certificate /etc/letsencrypt/live/openfoodsupplementsfacts.org/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/openfoodsupplementsfacts.org/privkey.pem;
    ssl_trusted_certificate /etc/letsencrypt/live/openfoodsupplementsfacts.org/chain.pem;
    ...
    access_log off;
    # logs location
    # access_log  /var/log/nginx/openfoodsupplementsfacts.org.log  main buffer=256K flush=1s;
    error_log   /var/log/nginx/openfoodsupplementsfacts.org.errors.log;
...
#        proxy_cache_valid any 5s;
	...
	# proxy_buffering off disables caching
 	...
 	proxy_intercept_errors on;
        ...
        # Rate limiting
        limit_req zone=ofsf burst=120 nodelay; # burst=120 means you can do 240+120 requests
    ...
    location ~* 502\.(html|jpg)  {
       root /opt/openfoodsupplementsfacts-infrastructure/html/;
    }
